...
pub fn mean_obliquity(ep: Epoch) -> Angle {
    ...
    let ob_deg = 23.43929111111111 - 4680.93 / 3600. * u - 1.55 / 3600.0 * u.powi(2)
        + 1999.25 / 3600.0 * u.powi(3) - 51.38 / 3600.0 * u.powi(4)
        - 249.67 / 3600.0 * u.powi(5) - 39.05 / 3600.0 * u.powi(6)
        + 7.12 / 3600.0 * u.powi(7) + 27.87 / 3600.0 * u.powi(8)
        + 5.79 / 3600.0 * u.powi(9) + 2.45 / 3600.0 * u.powi(10);
